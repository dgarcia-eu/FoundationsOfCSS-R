...
The boot function is very useful when you are doing all kinds of resampling tasks. For example, if you want to speed up your computations when doing permutation tests, which we will do later in the course, you can use boot() with the parameter *sim* set to 'permutation'.
