...
As you see, the nodes of the graph above form a single cycle, a ring, and are numbered from 1 to 12. You can generate other kinds of graphs, some of them with a random component. 
