...
- Measuring importance in social network: definitions matter!
  - if number of connections: degree
  - if brokering paths: betweenness
  - if reaching others: closeness
  
  
- Dunbar's number as a limit to degree in social networks
