...
- Computational Social Systems and new social data
  - R tutorials including data wrangling with dplyr
...
- After this lecture: discussion of solutions to Twitter API exercise
- Exercise starting this week: Division of impact on Twitter.   
  Submit your solutions **before next solution session** for extra grade!
