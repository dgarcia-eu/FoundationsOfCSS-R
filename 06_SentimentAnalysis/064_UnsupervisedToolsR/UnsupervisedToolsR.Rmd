...
afinndf
```
As you see, even the most negative character (Stanley) still has a positive mean sentiment score. This is called the postivity bias of language and you can test it yourself if you stream some tweets in English and run sentiment analysis on them.
...
```
Something about 0.75 is not so strong given that these two measurements should be very similar. There is a lot of research going on comparing sentiment analyses like these, the most important is to choose one that can be validated for your application case as you can learn later in the exercise about evaluating sentiment analysis.