...
The table shows you the estimates of the coefficients, in this case there is an intercept and a coefficient for FOI. The last column of the table shows what is called a p-value, we will learn more about how that is calculated and what it means later in the course. The $R^2$ of 0.44 we get means that we can explain 44\% of the variance of the GPD per capita with the FOI values of the countries alone.
